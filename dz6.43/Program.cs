...
if (ValidateLines(lineData1, lineData2))
{
    ...
    Console.Write($"Точка пересечения уравнений у={lineData1[COEFFICENT]}*х+{lineData1[CONSTANT]} и у={lineData2[COEFFICENT]}*х+{lineData2[CONSTANT]} ");
...
double[] InputLineData(int numberOfLine)
{
    ...
    lineData[COEFFICENT] = Prompt($"Введите коэфицент для {numberOfLine} прямой >");
